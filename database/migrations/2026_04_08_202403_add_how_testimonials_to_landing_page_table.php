...
return new class extends Migration {
    public function up(): void
    {
        Schema::table('landing_page', function (Blueprint $table) {
            ...
            // Testimonials (FIX: removed TEXT defaults)
            $table->text('testimonial1_text')->after('step3_desc');
            ...
            $table->text('testimonial2_text')->after('testimonial1_role');
            ...
            $table->text('testimonial3_text')->after('testimonial2_role');
