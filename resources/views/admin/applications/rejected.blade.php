<x-app-layout>
    <x-slot name="header">
        <h2 class="font-semibold text-xl leading-tight" style="color:#e2e8f0;">Rejected Applications</h2>
    </x-slot>
                ...
                <table class="min-w-full">
                    <thead>
                        <tr style="background:#0A1628;border-bottom:1px solid #1E3A8A;">
                            ...
                            <th class="px-6 py-3 text-left text-xs font-semibold uppercase" style="color:#8b949e;">Rejected Date</th>
                            <th class="px-6 py-3 text-left text-xs font-semibold uppercase" style="color:#8b949e;">Reason</th>
                    ...
                    <tbody>
                        ...
                        <tr style="border-bottom:1px solid #1E3A8A;">
                            ...
                            <td class="px-6 py-4 text-sm" style="color:#8b949e;">{{ $app->reviewed_at ? $app->reviewed_at->format('M d, Y') : 'N/A' }}</td>
                            <td class="px-6 py-4 text-sm max-w-xs truncate" style="color:#8b949e;" title="{{ $app->remarks ?? 'No reason provided' }}">
                                {{ $app->remarks ?? 'No reason provided' }}
                            </td>
                            <td class="px-6 py-4">
                        ...
                        @empty
                        <tr><td colspan="6" class="px-6 py-10 text-center text-sm" style="color:#8b949e;">No rejected applications.</td></tr>
                        @endforelse
                    </tbody>
                </table>
            </div>
