<x-app-layout>
    <x-slot name="header">
        <h2 class="font-semibold text-xl leading-tight" style="color:#e2e8f0;">Applications for Review</h2>
    </x-slot>
            ...
            <div class="overflow-x-auto">
                <table class="min-w-full">
                    ...
                    <tbody>
                        ...
                        @empty
                        <tr><td colspan="7" class="px-6 py-10 text-center text-sm" style="color:#8b949e;">No applications for review.</td></tr>
                        @endforelse
                    </tbody>
                </table>
            </div>
