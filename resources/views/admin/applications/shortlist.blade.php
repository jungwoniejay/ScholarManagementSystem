<x-app-layout>
    <x-slot name="header">
        <h2 class="font-semibold text-xl leading-tight" style="color:#e2e8f0;">Shortlisted Applications</h2>
    </x-slot>
                ...
                <table class="min-w-full">
                    <thead>
                        <tr style="background:#0A1628;border-bottom:1px solid #1E3A8A;">
                            ...
                            <th class="px-6 py-3 text-left text-xs font-semibold uppercase" style="color:#8b949e;">AI Rank</th>
                    ...
                    <tbody>
                        ...
                        <tr style="border-bottom:1px solid #1E3A8A;">
                            ...
                            <td class="px-6 py-4 text-sm" style="color:#60a5fa;">{{ $app->ai_rank ?? 'N/A' }}</td>
                            <td class="px-6 py-4">
                                <span class="px-2 py-1 text-xs font-semibold rounded-full" style="background:rgba(167,139,250,0.15);color:#a78bfa;">
                                    Shortlisted
                                </span>
                            </td>
                            <td class="px-6 py-4">
                        ...
                        @empty
                        <tr><td colspan="6" class="px-6 py-10 text-center text-sm" style="color:#8b949e;">No shortlisted applications.</td></tr>
                        @endforelse
                    </tbody>
                </table>
            </div>
