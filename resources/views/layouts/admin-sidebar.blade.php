...
<div id="admin-sidebar"
    ...
    <nav class="flex-1 overflow-y-auto py-3" style="scrollbar-width:thin;scrollbar-color:rgba(255,255,255,.1) transparent;">
        ...
        <a href="{{ route('admin.disbursements.withdrawals') }}"
           class="sb-item {{ request()->routeIs('admin.disbursements.*') ? 'active' : '' }}">
            <svg width="17" height="17" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24">
                <path stroke-linecap="round" stroke-linejoin="round"
                      d="M17 9V7a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2m2 4h10a2 2 0 002-2v-6a2 2 0 00-2-2H9a2 2 0 00-2 2v6a2 2 0 002 2zm7-5a2 2 0 11-4 0 2 2 0 014 0z"/>
            </svg>
            Withdrawals
            @php $pendingWithdrawals = \App\Models\WalletTransaction::where('type','withdrawal')->where('status','pending')->count(); @endphp
            <span class="sb-badge sb-badge-amber">{{ $pendingWithdrawals ?: '' }}</span>
        </a>
