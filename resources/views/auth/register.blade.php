        ...
        <div class="mt-4">
            ...
            <div class="mt-2 grid grid-cols-2 gap-3">
                <label class="relative flex cursor-pointer">
                    ...
                    <div class="w-full flex items-center gap-2 px-4 py-3 rounded-xl border-2 border-slate-200 peer-checked:border-yellow-500 peer-checked:bg-yellow-50 transition-all text-sm font-medium text-slate-700 peer-checked:text-yellow-800">
